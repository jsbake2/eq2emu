--[[
    ...
    Script Purpose :
                   :
    Patched        : tick() referenced 'Tickmax' (lowercase m) — Lua treats
                     it as a nil global and the multiplication crashes every
                     tick. Corrected to TickMax to match the function arg.
--]]
